...
<br> Subset the dataset only for the validation cohort, used deriv ==v to subset it..
...
#prune_samples(physeq_bact, "validation")
...
p + geom_boxplot(data=p$data, aes(x=HSILnew, y=value, color=NULL), alpha=0.1) +
    ggtitle("Diversity measures in validation cohorts by HSIL groups") +
...
# Alpha diversity - ggstatplot  in HSIL groups
...
pcomb<-combine_plots(
  ...
  annotation.args = list(
    title = "Diversity measures in validation cohorts by HSIL groups"
...
ggsave("ggstat_alpha_allplots1_validation.pdf", width = 42, height = 20, units = "cm", dpi = 600)
ggsave("ggstat_alpha_allplots1_validation.jpg",bg="white",width=18, height=12, dpi = 500)

```


# Alpha diversity - ggstatplot  in sexual role groups

```{r ggstatsex,echo=TRUE, message=FALSE,warning=FALSE,fig.height=5, fig.width=10}
################## alpha diversity
...
pfish<-ggbetweenstats(ps1.meta, x=sexual_roles, y=Fisher, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "sexual_roles",
    y = "Fisher index",
    palette = "Set2")+
...
pshan<-ggbetweenstats(ps1.meta, x=sexual_roles, y=Shannon, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "sexual_roles",
    y = "Shannon index",
    palette = "Set2")+
...
pobs<-ggbetweenstats(ps1.meta, x=sexual_roles, y=Observed, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "sexual_roles",
    y = "Observed richness",
    palette = "Set2")+
...
pchao<-ggbetweenstats(ps1.meta, x=sexual_roles, y=Chao1, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "sexual_roles",
    y = "Chao1 index ",
    palette = "Set2")+
...
pace<-ggbetweenstats(ps1.meta, x=sexual_roles, y=ACE, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "sexual roles",
    y = "ACE index ",
    palette = "Set2")+
...
pinv<-ggbetweenstats(ps1.meta, x=sexual_roles, y=InverseSimpson, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "sexual roles",
    y = "Inverse Simpson index ",
    palette = "Set2")+
...
pcomb<-combine_plots(
 # list(pobs, pchao, pace, pshan,pinv, pfish),
  list(pobs, pchao, pshan,pinv, pfish),
    plotgrid.args = list(nrow = 2),
  annotation.args = list(
    title = "Diversity measures in validation cohorts by sexual role groups"
    #caption = "Source: Gapminder Foundation"
  )
)
```
...
```{r ggstatplot2,echo=TRUE, message=FALSE,warning=FALSE,fig.height=5, fig.width=10}
pcomb

#ggsave("ggstat_alpha_allplots1_sexualrole_validation.jpg",bg="white",width=16, height=8)
ggsave("ggstat_alpha_allplots1_sexualrole_validation.pdf", width = 42, height = 20, units = "cm", dpi = 600)
ggsave("ggstat_alpha_allplots1_sexualrole_validation.jpg",bg="white",width=18, height=12, dpi = 500)

```

# Alpha diversity - ggstatplot  in cAIN groups

```{r ggstatain,echo=TRUE, message=FALSE,warning=FALSE,fig.height=5, fig.width=10}
################## alpha diversity
...
pfish<-ggbetweenstats(ps1.meta, x=cAIN, y=Fisher, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "bHSIL",
    y = "Fisher index",
    palette = "Set2")+
...
pshan<-ggbetweenstats(ps1.meta, x=cAIN, y=Shannon, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "bHSIL",
    y = "Shannon index",
    palette = "Set2")+
...
pobs<-ggbetweenstats(ps1.meta, x=cAIN, y=Observed, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "bHSIL",
    y = "Observed richness",
    palette = "Set2")+
...
pchao<-ggbetweenstats(ps1.meta, x=cAIN, y=Chao1, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "bHSIL",
    y = "Chao1 index ",
    palette = "Set2")+
...
pace<-ggbetweenstats(ps1.meta, x=cAIN, y=ACE, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "bHSIL",
    y = "ACE index ",
    palette = "Set2")+
...
pinv<-ggbetweenstats(ps1.meta, x=cAIN, y=InverseSimpson, type = "nonparametric",plot.type = "violin")+
  labs(
    x = "bHSIL",
    y = "Inverse Simpson index ",
    palette = "Set2")+
...
pcomb<-combine_plots(
  ...
  plotgrid.args = list(nrow = 2),
  annotation.args = list(
    title = "Diversity measures in validation cohorts by cAIN groups"
    #caption = "Source: Gapminder Foundation"
  )
)
```
...
```{r ggstatplotain,echo=TRUE, message=FALSE,warning=FALSE,fig.height=5, fig.width=10}
pcomb

#ggsave("ggstat_alpha_allplots1_cAIN_validation.jpg",bg="white",width=16, height=8)
ggsave("ggstat_alpha_allplots1_cAIN_validation.pdf", width = 42, height = 20, units = "cm", dpi = 600)
ggsave("ggstat_alpha_allplots1_cAIN_validation.jpg",bg="white",width=18, height=12, dpi = 500)
...
pseq2<-ps2
p4 <- plot_composition(pseq2,  taxonomic.level = "Family", sample.sort = "HSILnew", group_by="HSILnew",
                       x.label = "HSILnew") + guides(fill = guide_legend(ncol = 1)) +  
  scale_fill_manual(values = mycolors) +
  #scale_fill_brewer("Family", palette = "Paired") +
  scale_y_percent() + labs(x = "Samples", y = "Relative abundance (%)",
                           title = "Relative abundance of family in validation cohort")+ theme_ipsum(grid="Y")+ theme(axis.text.x=element_blank(), axis.ticks.x=element_blank())

print(p4)

ggsave("relabund_family_all_validation.jpg",bg="white",width=10, height=8)

# Averaged by group
p44 <- plot_composition(pseq2, average_by = "HSILnew", transform = "compositional") +
  #scale_fill_brewer("Family", palette = "Paired") + 
    scale_fill_manual(values = mycolors) +
theme_ipsum(grid="Y") +
...
ggsave("relabund_family_combined_validation.jpg",bg="white",width=8, height=8)

##### GENUS

ps3 <- ps1 %>% aggregate_top_taxa2(level = "Genus", top = 15) %>% microbiome::transform(transform = "compositional")
pseq2<-ps3
p5 <- plot_composition(pseq2,  taxonomic.level = "Genus", sample.sort = "HSILnew", group_by="HSILnew",
                       x.label = "HSILnew") + guides(fill = guide_legend(ncol = 1)) +   
  #scale_fill_brewer("Genus", palette = "Paired") +
  scale_fill_manual(values = mycolors) +
  scale_y_percent() + labs(x = "Samples", y = "Relative abundance (%)",
                           title = "Relative abundance of genus in validation cohort")+ 
  theme_ipsum(grid="Y")+ theme(axis.text.x=element_blank(), axis.ticks.x=element_blank())

print(p5)

ggsave("relabund_Genus_all_validation.jpg",bg="white",width=10, height=8)

# Averaged by group
p55 <- plot_composition(pseq2, average_by = "HSILnew", transform = "compositional") +
  #scale_fill_brewer("Genus", palette = "Paired") +
    scale_fill_manual(values = mycolors) +
theme_ipsum(grid="Y") +
  theme(axis.text.x = element_text(angle=0, hjust=1), legend.text = element_text(face = "italic"))
...
ggsave("relabund_Genus_combined_validation.jpg",bg="white",width=8, height=8)
...
print(unwt.unifrac)
ggsave("betadiv_nmds_HSIL_validation.jpg",bg="white")
ggsave("betadiv_nmds_HSIL_validation.pdf")
...
permanova <- adonis2(unifrac.dist ~ HSILnew, data = metadf)
...
jpeg(file="centroiddisperHSILnew_validation.jpeg")
plot(beta2, main = "Ordination Centroids and Dispersion Labeled: Unweighted Unifrac Distance", sub = "")  
dev.off()

boxplot(beta2, main = "", xlab = "")

jpeg(file="centroidboxplotHSILnew_validation.jpeg")
boxplot(beta2, main = "", xlab = "")
dev.off()
...
psbAIN<-subset_samples(ps1, bAINcat=="HSIL"  | bAINcat=="LSIL" | bAINcat=="Normal")
ordu.unwt.uni <- ordinate(psbAIN, "NMDS", "unifrac", weighted=F)

unwt.unifrac <- plot_ordination(psbAIN, ordu.unwt.uni, color="bAINcat")+ 
...
print(unwt.unifrac)
ggsave("betadiv_nmds_bIANcat1_validation.jpg",bg="white")
ggsave("betadiv_nmds_bIANcat1_validation.pdf")

metadf <- data.frame(sample_data(psbAIN))

unifrac.dist <- UniFrac(psbAIN,
                        weighted = TRUE,
                        normalized = TRUE,
                        parallel = FALSE,
                        fast = TRUE)
#Permanova analysis using Vegan (adonis)
permanova <- adonis2(unifrac.dist ~ bAINcat, data = metadf)
permanova
```
...
jpeg(file="centroiddisperbAINcat_validation.jpeg")
plot(beta2, main = "Ordination Centroids and Dispersion Labeled: Unweighted Unifrac Distance", sub = "")  
dev.off()

boxplot(beta2, main = "", xlab = "")

jpeg(file="centroidboxplotbAINcat_validation.jpeg")
boxplot(beta2, main = "", xlab = "")
dev.off()
...
# Betadiversity in sexual role groups

<br>PERMANOVA quantifies multivariate community-level differences between groups.
<br>Permanova analysis used on unifrac distances and showed it in a NMDS plot. <br>
```{r beta_sexrole, echo=TRUE, message=FALSE, warning=FALSE}
pssexr<-subset_samples(ps1, sexual_roles=="Both"  | sexual_roles=="Active" | sexual_roles=="Passive")

ordu.unwt.uni <- ordinate(pssexr, "NMDS", "unifrac", weighted=F)

# check for Eigen values
# barplot(ordu.unwt.uni$values$Eigenvalues[1:10])

unwt.unifrac <- plot_ordination(pssexr, ordu.unwt.uni, color="sexual_roles")+ 
  stat_ellipse(aes(group = sexual_roles), linetype = 2)
unwt.unifrac <- unwt.unifrac + ggtitle("Unweighted UniFrac") + geom_point(size = 2.5)

unwt.unifrac <- unwt.unifrac + theme_classic() + scale_color_brewer("sexual_roles", palette = "Set2")
print(unwt.unifrac)
ggsave("betadiv_nmds_HSIL_validation__sexrole_.jpg",bg="white")
ggsave("betadiv_nmds_HSIL_validation__sexrole_.pdf")

metadf <- data.frame(sample_data(pssexr))

unifrac.dist <- UniFrac(pssexr,
                        weighted = TRUE,
                        normalized = TRUE,
                        parallel = FALSE,
                        fast = TRUE)
#Permanova analysis using Vegan (adonis)
permanova <- adonis2(unifrac.dist ~ sexual_roles, data = metadf)
...
```{r betadisp_sexrole, echo=TRUE, message=FALSE, warning=FALSE}
beta2 <- betadisper(unifrac.dist, metadf$sexual_roles)
permutest(beta2)

plot(beta2, main = "Ordination Centroids and Dispersion Labeled: Unweighted Unifrac Distance", sub = "")  

jpeg(file="centroiddispersexual_roles_validation.jpeg")
plot(beta2, main = "Ordination Centroids and Dispersion Labeled: Unweighted Unifrac Distance", sub = "")  
dev.off()

boxplot(beta2, main = "", xlab = "")

jpeg(file="centroidboxplotsexual_roles_validation.jpeg")
boxplot(beta2, main = "", xlab = "")
dev.off()
...
ggsave("volcanopltdeseq_hsil_validation.jpg",bg="white")
