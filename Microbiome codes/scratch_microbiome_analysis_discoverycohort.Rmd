...
# Subset data for discovery cohort

<br> Subset the dataset only for the discovery cohort, used deriv !=1 to subset it..
...
p + geom_boxplot(data=p$data, aes(x=HSILnew, y=value, color=NULL), alpha=0.1) +
    ggtitle("Diversity measures in discovery cohorts by HSIL groups") +
...
pcomb<-combine_plots(
  ...
  annotation.args = list(
    title = "Diversity measures in discovery cohorts by HSIL groups"
...
ggsave("ggstat_alpha_allplots1_discovery.pdf", width = 42, height = 20, units = "cm", dpi = 600)
ggsave("ggstat_alpha_allplots1_discovery.jpg",bg="white",width=18, height=12, dpi = 500)
...
pcomb<-combine_plots(
 # list(pobs, pchao, pace, pshan,pinv, pfish),
  list(pobs, pchao, pshan,pinv, pfish),
    plotgrid.args = list(nrow = 2),
  annotation.args = list(
    title = "Diversity measures in discovery cohorts by sexual role groups"
    #caption = "Source: Gapminder Foundation"
  )
)
```
...
#ggsave("ggstat_alpha_allplots1_sexualrole_discovery.jpg",bg="white",width=16, height=8)
ggsave("ggstat_alpha_allplots1_sexualrole_discovery.pdf", width = 42, height = 20, units = "cm", dpi = 600)
ggsave("ggstat_alpha_allplots1_sexualrole_discovery.jpg",bg="white",width=18, height=12, dpi = 500)
...
pcomb<-combine_plots(
  ...
  plotgrid.args = list(nrow = 2),
  annotation.args = list(
    title = "Diversity measures in discovery cohorts by cAIN groups"
    #caption = "Source: Gapminder Foundation"
  )
)
```
...
#ggsave("ggstat_alpha_allplots1_cAIN_discovery.jpg",bg="white",width=16, height=8)
ggsave("ggstat_alpha_allplots1_cAIN_discovery.pdf", width = 42, height = 20, units = "cm", dpi = 600)
ggsave("ggstat_alpha_allplots1_cAIN_discovery.jpg",bg="white",width=18, height=12, dpi = 500)
...
p4 <- plot_composition(pseq2,  taxonomic.level = "Family", sample.sort = "HSILnew", group_by="HSILnew",
  ...
  scale_y_percent() + labs(x = "Samples", y = "Relative abundance (%)",
                           title = "Relative abundance of family in discovery cohort")+ theme_ipsum(grid="Y")+ theme(axis.text.x=element_blank(), axis.ticks.x=element_blank())

print(p4)

ggsave("relabund_family_all_discovery.jpg",bg="white",width=10, height=8)
...
ggsave("relabund_family_combined_discovery.jpg",bg="white",width=8, height=8)
...
p5 <- plot_composition(pseq2,  taxonomic.level = "Genus", sample.sort = "HSILnew", group_by="HSILnew",
  ...
  scale_fill_manual(values = mycolors) +
  scale_y_percent() + labs(x = "Samples", y = "Relative abundance (%)",
                           title = "Relative abundance of genus in discovery cohort")+ 
  theme_ipsum(grid="Y")+ theme(axis.text.x=element_blank(), axis.ticks.x=element_blank())

print(p5)

ggsave("relabund_Genus_all_discovery.jpg",bg="white",width=10, height=8)
...
ggsave("relabund_Genus_combined_discovery.jpg",bg="white",width=8, height=8)
...
print(unwt.unifrac)
ggsave("betadiv_nmds_HSIL_discovery.jpg",bg="white")
ggsave("betadiv_nmds_HSIL_discovery.pdf")
...
jpeg(file="centroiddisperHSILnew_discovery.jpeg")
plot(beta2, main = "Ordination Centroids and Dispersion Labeled: Unweighted Unifrac Distance", sub = "")  
dev.off()

boxplot(beta2, main = "", xlab = "")

jpeg(file="centroidboxplotHSILnew_discovery.jpeg")
boxplot(beta2, main = "", xlab = "")
dev.off()
...
print(unwt.unifrac)
ggsave("betadiv_nmds_bIANcat1_discovery.jpg",bg="white")
ggsave("betadiv_nmds_bIANcat1_discovery.pdf")
...
jpeg(file="centroiddisperbAINcat_discovery.jpeg")
plot(beta2, main = "Ordination Centroids and Dispersion Labeled: Unweighted Unifrac Distance", sub = "")  
dev.off()

boxplot(beta2, main = "", xlab = "")

jpeg(file="centroidboxplotbAINcat_discovery.jpeg")
boxplot(beta2, main = "", xlab = "")
dev.off()
...
print(unwt.unifrac)
ggsave("betadiv_nmds_HSIL_discovery__sexrole_.jpg",bg="white")
ggsave("betadiv_nmds_HSIL_discovery__sexrole_.pdf")
...
jpeg(file="centroiddispersexual_roles_discovery.jpeg")
plot(beta2, main = "Ordination Centroids and Dispersion Labeled: Unweighted Unifrac Distance", sub = "")  
dev.off()

boxplot(beta2, main = "", xlab = "")

jpeg(file="centroidboxplotsexual_roles_discovery.jpeg")
boxplot(beta2, main = "", xlab = "")
dev.off()
...
ggsave("volcanopltdeseq_hsil_discovery.jpg",bg="white")
